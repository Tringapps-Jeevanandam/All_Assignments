...
public class TicTacToe {
    ...
    protected static void settingPos(char[][] board, String player, int pos) {
        char sym = ' ';
        if (player.equals("p1")) {
            sym = 'x';
    ...
    protected static boolean isEmpty(char[][] board,int pos){
        switch(pos){
    ...
    protected static boolean winner(char[][] board, char sym){
    ...
    protected static boolean gameResult(char[][] board) {
    ...
    protected static void player1Turn(char[][] board, Scanner scanner) {
		int p1pos;
		while (true) {
			Log.info("Player 1:");
    ...
    protected static void player2Turn(char[][] board, Scanner scanner) {
		int p2pos;
		while (true) {
			Log.info("Player 2:");
